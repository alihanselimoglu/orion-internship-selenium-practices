...
public class TrendyolTests {
    ...
    public void testSuccessfulLogin() {
        ...
        Assert.assertTrue(accountButton.isDisplayed(), "Login was not successful");
    }
    ...
    public void testInvalidUsername() {
        ...
        Assert.assertEquals(errorMessage.getText(), "E-posta adresiniz ve/veya şifreniz hatalı.", "Error message text is incorrect");
    }
    ...
    public void testNumberOfElbiseResults() {
        ...
        Assert.assertTrue(itemCount > 0, "No items found for search term 'Elbise'");
    }
    ...
    public void testAddElbiseItemToCart() throws InterruptedException {
        ...
        Assert.assertTrue(cartItemCount.isDisplayed(), "Item was not added to the cart");
    }
}
